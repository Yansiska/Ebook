<%-- 
    Document   : edit_admin
    Created on : Apr 11, 2018, 2:38:14 PM
    Author     : Jasmine
--%>
         ...
         <form role="form" action="UpdateAdmin" method="POST">
								...
								<div class="form-group">
									<label>ID Admin</label>
                                                                        <input class="form-control"  value="<%=idadmin%>" name="id" readonly="" required="">
								</div>
                                                        
                                                                <div class="form-group">
									<label>Nama</label>
                                                                        <input class="form-control" name="nama" data-minlength="6" value="<%=nama_admin%>" required="">
								</div>
                                                        
                                                                <div class="form-group">
									<label>Alamat</label>
                                                                        <textarea class="form-control" name="alamat" rows="3" ><%=alamat_admin%></textarea>
								</div>
                                                        
                                                                <div class="form-group">
									<label>Username</label>
                                                                        <input class="form-control" name="user" value="<%=username%>"required="">
								</div>
